...
public class RingSwitcher : MonoBehaviour {
    ...
    public void Switch () {
        if (ctf_objects[index_active].GetComponent<FireRing>()) { ctf_objects[index_active].GetComponent<FireRing>().Deactivate(); }
        else ctf_objects[index_active].SetActive(false);
        ...
        index_active = temp;
        ctf_objects[index_active].SetActive(true);
        if (ctf_objects[index_active].GetComponent<FireRing>()) { ctf_objects[index_active].GetComponent<FireRing>().Activate(); }
    }
